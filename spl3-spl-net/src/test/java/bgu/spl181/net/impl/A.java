        ...
        public void run(){
            ...
            try {
                ...
                try(OutputStreamWriter theClientTestResultsStream = new OutputStreamWriter(new FileOutputStream(
                    ...
                    commands = readTestDataFromFile(filename + "_commands");

                    serverResponse = readTestDataFromFile(filename + "_responses");

                    serverBroadcast = readTestDataFromFile(filename + "_broadcasts");
